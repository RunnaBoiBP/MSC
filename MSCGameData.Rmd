...
**HSW:  There is an easier regex for the above work.  See the code below.  The same goes for the three-pointer split, so I'll make that change directly.**
...
MSCDataFinal=data.frame(MSCDataX3PMSplit,
                        X2PM=MSCDataX3PMSplit$FGM-MSCDataX3PMSplit$X3PM,
