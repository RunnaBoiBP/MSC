...
The following code shows the Offensive Efficiency Rankings for the 9 Mid-South Conference Teams in 2014, 2015, and 2016, respectively. (Note, St. Catharine (Ky.) ceased to exist following the 2015 season, so there are only 8 MSC teams in 2016).
