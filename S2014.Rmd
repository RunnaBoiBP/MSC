...
page <- read_html("/home/GEORGETOWNCOLLEGE.EDU/bpeterson/MSCBballShiny/DakStatsPages/MSCbball1415.html")
```

In a project, this should be:

```{r}
page <- read_html("DakStatsPages/MSCbball1415.html")
```

Relative URLs are almost always best, as they work even when you share your repository with other people.
